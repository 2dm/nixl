...
// Configuration for high-throughput kernels
struct Config {
    int num_sms;
    ...
    size_t get_internode_rdma_buffer_size_hint(int64_t hidden_bytes, int num_ranks) const {
        // Internode high-throughput mode - no RDMA buffer needed for intranode
